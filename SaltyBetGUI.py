...
class SaltyBetGUI:
    ...
    def create_users_tab(self):
        ...
        # Add user section
        add_user_frame = tk.LabelFrame(users_frame,
                                       text="Add New User",
                                       font=('Arial', 10, 'bold'),
                                       bg='#34495e',
                                       fg='white')
        ...
        add_user_btn = tk.Button(add_user_frame,
                                 text="Add User",
        ...
        # Users list section
        users_list_frame = tk.LabelFrame(users_frame,
                                         text="Current Users",
                                         font=('Arial', 10, 'bold'),
                                         bg='#34495e',
                                         fg='white')
    ...
    def create_match_tab(self):
        ...
        match_type_frame = tk.LabelFrame(match_frame,
        ...
        match_types = [
            "One on One", "Triple Threat", "Fatal 4 Way", "Five Way",
            "Six Way", "Seven Way", "Eight Way"
        ]

        match_type_combo = ttk.Combobox(match_type_frame,
        ...
        wrestlers_frame = tk.LabelFrame(match_frame,
                                        text="Enter Wrestlers/Teams",
                                        font=('Arial', 10, 'bold'),
                                        bg='#34495e',
                                        fg='white')
        ...
        # Setup button
        setup_match_btn = tk.Button(match_frame,
                                    text="Setup Match",
        ...
        self.current_match_label = tk.Label(match_frame,
                                            text="No match set up",
                                            font=('Arial', 10),
                                            bg='#34495e',
                                            fg='#ecf0f1')
        ...
        match_type_combo.bind('<<ComboboxSelected>>',
    ...
    def create_betting_tab(self):
        ...
        # User selection
        user_frame = tk.LabelFrame(betting_frame,
                                   text="Select User",
                                   font=('Arial', 10, 'bold'),
                                   bg='#34495e',
                                   fg='white')
        ...
        self.betting_user_combo = ttk.Combobox(
            user_frame,
            textvariable=self.betting_user_var,
            state='readonly',
            width=20,
            font=('Arial', 9))
        ...
        # Wrestler selection
        wrestler_frame = tk.LabelFrame(betting_frame,
                                       text="Select Wrestler/Team to Bet On",
                                       font=('Arial', 10, 'bold'),
                                       bg='#34495e',
                                       fg='white')
        wrestler_frame.pack(fill='x', padx=10, pady=10)

        tk.Label(wrestler_frame,
                 text="Wrestler:",
                 bg='#34495e',
                 fg='white',
                 font=('Arial', 9)).pack(side='left', padx=5)
        ...
        self.betting_wrestler_combo = ttk.Combobox(
            wrestler_frame,
            textvariable=self.betting_wrestler_var,
            state='readonly',
            width=20,
            font=('Arial', 9))
        ...
        # Bet amount
        amount_frame = tk.LabelFrame(betting_frame,
                                     text="Bet Amount",
                                     font=('Arial', 10, 'bold'),
                                     bg='#34495e',
                                     fg='white')
        ...
        self.bet_amount_entry = tk.Entry(amount_frame,
                                         font=('Arial', 9),
                                         width=15)
        self.bet_amount_entry.pack(side='left', padx=5)

        # User's current WrestleBucks display
        self.user_money_label = tk.Label(amount_frame,
                                         text="",
                                         bg='#34495e',
                                         fg='#f39c12',
                                         font=('Arial', 9, 'bold'))
        ...
        # Place bet button
        place_bet_btn = tk.Button(betting_frame,
                                  text="Place Bet",
        ...
        bets_frame = tk.LabelFrame(betting_frame,
                                   text="Current Bets",
                                   font=('Arial', 10, 'bold'),
                                   bg='#34495e',
                                   fg='white')
        ...
        self.bets_text = scrolledtext.ScrolledText(bets_frame,
                                                   height=8,
                                                   bg='#2c3e50',
                                                   fg='white',
                                                   font=('Arial', 9))
        ...
        self.betting_user_combo.bind('<<ComboboxSelected>>',
    ...
    def create_resolution_tab(self):
        ...
        # Winner selection
        winner_frame = tk.LabelFrame(resolution_frame,
                                     text="Select Winner",
                                     font=('Arial', 10, 'bold'),
                                     bg='#34495e',
                                     fg='white')
        ...
        self.winner_combo = ttk.Combobox(winner_frame,
        ...
        resolve_btn = tk.Button(resolution_frame,
                                text="Resolve Match",
        ...
        # Results display
        results_frame = tk.LabelFrame(resolution_frame,
                                      text="Match Results",
                                      font=('Arial', 10, 'bold'),
                                      bg='#34495e',
                                      fg='white')
    ...
    def create_stats_tab(self):
        ...
        # Refresh button
        refresh_btn = tk.Button(stats_frame,
                                text="Refresh Stats",
    ...
    def setup_match_gui(self):
        ...
        for entry in self.wrestler_entries:
            ...
            if not name:
                messagebox.showerror("Error",
                                     "All wrestler names must be filled!")
                return
        ...
        self.current_match_label.config(
            text=f"{self.match_type_var.get()}: {match_display}")
        self.update_display()
    ...
    def place_bet_gui(self):
        ...
        if user_name in self.salty_bet.bets:
            messagebox.showerror(
                "Error",
                f"User '{user_name}' has already placed a bet for this match!")
            return
        ...
        self.update_display()
        messagebox.showinfo(
            "Success", f"Bet of {amount} WrestleBucks placed on {wrestler}!")
    ...
    def resolve_match_gui(self):
        ...
        for user_name, bet_info in self.salty_bet.bets.items():
            ...
            if bet_info['wrestler'] == winner:
                ...
                results.append(
                    f"{user_name}: Won! +{winnings} WrestleBucks (Total: {user.wrestlebucks})"
                )
            else:
                user.lose_bet()
                results.append(
                    f"{user_name}: Lost! WrestleBucks remain: {user.wrestlebucks}"
                )
    ...
    def update_betting_options(self, event=None):
        ...
        if user_name and user_name in self.salty_bet.users:
            user = self.salty_bet.users[user_name]
            self.user_money_label.config(
                text=f"Current: {user.wrestlebucks} WrestleBucks")
    ...
    def update_users_display(self):
        ...
        for user_name, user in self.salty_bet.users.items():
            ...
            self.users_tree.insert(
                '',
                'end',
                values=(stats['name'], stats['wrestlebucks'], stats['wins'],
                        stats['losses'], f"{stats['win_rate']:.1f}%"))
    ...
    def update_betting_display(self):
        ...
        if self.salty_bet.bets:
            ...
            for user_name, bet_info in self.salty_bet.bets.items():
                self.bets_text.insert(
                    tk.END,
                    f"• {user_name}: {bet_info['amount']} WrestleBucks on {bet_info['wrestler']}\n"
                )
        else:
    ...
    def update_stats_display(self):
        ...
        for user_name, user in self.salty_bet.users.items():
            ...
            self.stats_text.insert(tk.END,
                                   f"=== {stats['name']}'s Statistics ===\n")
            self.stats_text.insert(tk.END,
                                   f"WrestleBucks: {stats['wrestlebucks']}\n")
